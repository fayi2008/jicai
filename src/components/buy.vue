<template>
  <el-container style="height: 100%;padding:20px;" id="buy">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="需求部门">
            <el-input v-model="form.name" placeholder="根据需求人自动获取,再弹窗选取"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="收货人">
              <el-input v-model="form.name" placeholder="填写"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="开票抬头">
              <el-input v-model="form.name" placeholder="选取"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <table class="add-table">
          <thead>
            <tr>
              ...
              <td>邮箱</td>
              <td>电话</td>
              <td><el-button icon="el-icon-plus" circle></el-button></td>
            </tr>
          </thead>
          <tbody>
          <tr>
